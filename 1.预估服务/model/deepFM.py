...
def deepFM(feature_columns, DICT_CATEGORICAL):
    ...
    fm_logit = Add()([linear_logit, fm_cross_logit])
    ...
    ## 连接fm部分和nn部分
    input_layer = Concatenate(axis=1)([fm_logit, f2])
...
model = deepFM(feature_columns, DICT_CATEGORICAL)
model.summary()
